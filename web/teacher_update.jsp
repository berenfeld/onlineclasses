                    ...
                    <form id="teacher_update_form" onsubmit="return false">
                        ...
                        <div class="tab-content" id="teacher_update_tabs">
                            ...
                            <div class="card my-1 tab-pane fade show active" id="teacher_update_personal_information_tab" role="tabpanel" 
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-lg-6 my-0">
                                            <div class="row no-gutters" id="teacher_update_phone_number">   
                                                ...
                                                <div class="input-group form-control border-0 col-12 col-md">
                                                    <input type="text" class="col-8 form-control mr-md-3" id="teacher_update_phone_number_input"
                                                           onkeypress="return isNumberKey(event)"
                                                           placeholder="<%= Labels.get("teacher_update.form.login.phone_number")%>">

                                                    <select class="col-4 custom-select form-control" id="teacher_update_phone_area_select">
                                        ...
                                        <div class="col-6 col-lg-3 my-1">
                                            <select class="custom-select form-control" id="teacher_update_city_select">
                                ...
                                <div class="card-footer">
                                    <div class="d-flex flex-row-reverse">
                                        <button class="btn btn-info" onclick="teacher_update_goto_tab('profile')">
                            ...
                            <div class="card my-1 tab-pane fade" id="teacher_update_profile_tab" role="tabpanel" 
                                ...
                                <div class="card-footer">
                                    <div class="d-flex flex-row-reverse">
                                        <button class="btn btn-info" onclick="teacher_update_goto_tab('education')">
                                            <span class="oi" data-glyph="chevron-left"></span>                                            
                            ...
                            <div class="card my-1 tab-pane fade" id="teacher_update_education_tab" role="tabpanel" 
                                        ...
                                        <a class="list-group-item list-group-item-action" 
                                           ...
                                           href="#teacher_update_degree_information_div">
                                            <input class="form-check-input my-1 mx-0"  
                                                   ...
                                                   type="checkbox" value="">
                                            <label class="form-check-label" for="teacher_update_show_degree">
                                ...
                                <div class="card-footer">
                                    <div class="d-flex flex-row-reverse">
                                        <button class="btn btn-info" onclick="teacher_update_goto_tab('teaching_topics')">
                                            <span class="oi" data-glyph="chevron-left"></span>                                            
                            ...
                            <div class="card my-1 tab-pane fade" id="teacher_update_teaching_topics_tab" role="tabpanel" 
                                ...
                                <div class="card-footer">
                                    <div class="d-flex flex-row-reverse">
                                        <button class="btn btn-info" onclick="teacher_update_goto_tab('prices')">
                                            <span class="oi" data-glyph="chevron-left"></span>                                            
                            ...
                            <div class="card my-1 tab-pane fade" id="teacher_update_prices_tab" role="tabpanel" 
                                ...
                                <div class="card-footer">
                                    <div class="d-flex flex-row-reverse">
                                        <button class="btn btn-info" onclick="teacher_update_goto_tab('teaching_hours')">
                                            <span class="oi" data-glyph="chevron-left"></span>                                            
                            ...
                            <div class="card my-1 tab-pane fade" id="teacher_update_teaching_hours_tab" role="tabpanel" 
                                ...
                                <div class="card-footer">
                                    <div class="d-flex flex-row-reverse">
                                        <button class="btn btn-info" onclick="teacher_update_goto_tab('accept_and_finish')">
                                            <span class="oi" data-glyph="chevron-left"></span>                                            
                            ...
                            <div class="card my-1 tab-pane fade" id="teacher_update_accept_and_finish_tab" role="tabpanel" 
                                ...
                                <div class="card-footer">
                                    ...
                                    <div class="d-flex flex-row-reverse">
                                        ...
                                        <div>
                                            <button class="btn btn-success mx-1 my-auto" onclick="teacher_update_form_submit()">
                                                <span class="oi" data-glyph="chevron-left"></span>
